...
if(isset($_GET['code']))
{
	...
	foreach($result as $row)
	{
		...
		//$_SESSION["examTime"] = $exam_star_time;
		
        //echo $exam_star_time . " start time";
        //echo strtotime($exam_star_time) . " string to time";
		$duration = $row['online_exam_duration'] . ' minute';
		//$_SESSION["examDuration"] = $duration;

		$exam_end_time = strtotime($exam_star_time . '+' . $duration);
        //echo $exam_end_time .  " end time";
		$exam_end_time = date('Y-m-d H:i:s', $exam_end_time);
        //echo $exam_end_time .  "ending";
		$remaining_minutes = strtotime($exam_end_time) - time();
        ///echo $remaining_minutes. " rem";
...
<div class="row">
	...
	<div class="col-md-4">
		<br />
		<div align="center">
			<div id="exam_timer" data-timer="<?php echo $remaining_minutes/60; ?>" style="max-width:400px; width: 100%; height: 200px;"></div>
		</div>
		<br />
