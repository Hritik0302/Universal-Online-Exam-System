			...
			<div class="card" style="margin-top:50px;margin-bottom: 100px;">
                ...
                <form method="post" id="user_register_form">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="user_mobile_no" id="user_mobile_no" class="form-control"  data-parsley-trigger="keyup" data-parsley-minlength="10" data-parsley-maxlength="10" data-parsley-minlength-message="please enter valid mobile number" data-parsley-validation-threshold="10" /> 
                  </div>
                  <div class="form-group">
